...
## Download
Users should use the provided scripts for [Windows](./install.ps1) and [Linux/Mac](./install.sh) users to automatically download the latest version of capsule.
...
3. Run `./install.sh`.
3. Follow the interactive instructions. Press Y when prompted to add Capsule to your path and to create a symlink.
